...
Все команды выполняются из папки `project04`.
...
Выполни один раз: команда создаст `.env` с новым случайным паролем БД.
...
lines.append(f"DATABASE_URL=postgresql://school21:{password}@127.0.0.1:55404/school21")
